        ...
        <div className={classes.list}>
            {sortedBooks.map((book, i) => {
                if (book && counter < bookspp) {
                    ...
                    for (
                        let index = 0;
                        index < Math.floor(parseInt(book.dummyrating)) - 1;
                        index++
                    ) {
                        rat = rat + '⭐'
                    }
                    ...
                    if (
                        props.books.filterfields != '' &&
                        props.books.filterfields != 'null'
                    ) {
                        if (
                            book.categories[0] == props.books.filterfields ||
                            book.categories[1] == props.books.filterfields
                        ) {
                            counter++
                            return (
                                <BookCard
